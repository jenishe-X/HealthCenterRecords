...
<main>
    ...
    <section id="introPage" class="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-x-0 py-sm:py-0">
        <div class="flex flex-col lg:justify-center text-center lg:text-left lg:pl-10 gap-8 md:gap-10 lg:gap-8">
            <h2 class="font-semibold text-6xl text-white sm:text-7xl md:text-7xl">
                Medical Records Monitoring System
            </h2>
            <p class="text-base text-white sm:text-lg md:text-xl typing-text">
                {currentText}
            </p>
            <a href="/" class="block">
              <button class="mx-auto lg:mr-auto lg:ml-0 text-base sm:text-lg md:text-xl poppins relative overflow-hidden px-6 py-3 group rounded-full bg-white text-green-950">
                <div class="absolute top-0 right-full w-full h-full bg-green-600 opacity-20 group-hover:translate-x-full z-0 duration-200"></div>
                <h4 class="relative z-9">Check Records &rarr;</h4>
              </button>
            </a>
        </div>
        <div class="relative place-items-center">
            <div class="relative max-h-[70vh]">
                <img src="assets/logo.png" alt="Jenishe Salem" class="object-cover z-[1] max-h-[60vh]" />
