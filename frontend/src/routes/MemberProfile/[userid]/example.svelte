<script lang="ts">
  ...
  philbday?: Date;
    ...
    let userid: string = $page.params.userid; // Access dynamic parameter
    let member: Member | null = null; // Member object
    let isLoading = true;
  
    // Simulate fetching member details from an API or database
    onMount(async () => {
      try {
